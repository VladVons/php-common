...
class tMacros_MVideo extends tMacros_FileClass
{
	const	cFileName	= 0, 
			cSkin		= 1,
			cWidth		= 2;
	const	cSyntax		= "FileName|[Skin]|[Width]";
	const	cMask		= "(.avi$|.flv$|.mpg4$)";
	const	cDescr		= <<<BAR
href="http://jdv-soft.com/index.php?PN=Help&PS=ProjSimpleSiteCreator/Macros_MVideo"
BAR;
	...
	public function InitDefParam()
	{
		switch($this->TArrParam->GetCount()) {
			case 1: $this->SetDefParam("Skin", "uppodStyleV1.txt");
