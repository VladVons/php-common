...
class tMacros_FormSubmit extends tMacros_BaseClass
{
	const	cName	= 0, 
			cText	= 1, 
			cClass	= 2;
	...
	const	cDescr	= <<<BAR
href="http://jdv-soft.com/index.php?PN=Help&PS=ProjSimpleSiteCreator/Macros_FormSubmit"
BAR;
	...
	public function InitDefParam()
	{
		switch($this->TArrParam->GetCount()) {
			case 1: $this->TArrParam[self::cText]  = "OK";
