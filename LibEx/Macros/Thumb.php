...
class tMacros_Thumb extends tMacros_FileClass
{
	const	cFileName	= 0, 
			cText		= 1, 
			cAlign		= 2, 
	...
	const	cDescr		= <<<BAR
href="http://jdv-soft.com/index.php?PN=Help&PS=ProjSimpleSiteCreator/Macros_Thumb"
BAR;
