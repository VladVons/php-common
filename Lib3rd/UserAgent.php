...
class TUserAgent
{
	private $linux_proc, $mac_proc, $lang; 
	

	function __construct()
	{
		$this->linux_proc = array('i686', 'x86_64');
		$this->mac_proc   = array('Intel', 'PPC', 'U; Intel', 'U; PPC');
		$this->lang		  = array('en-US', 'sl-SI');
	}


	protected function firefox() 
	{
		$ver = array(
	...
	public function GetRandom() {
		$x = rand(1, 5);
		switch ($x) {
			case 1:	return "Mozilla/5.0 " . $this->firefox();
			case 2:	return "Mozilla/5.0 " . $this->safari();
			case 3:	return "Mozilla/" . rand(4, 5) . ".0 " . $this->iexplorer();
			case 4:	return "Opera/" . rand(8, 9) . '.' . rand(10, 99) . ' ' . $this->opera();
			case 5:	return 'Mozilla/5.0' . $this->chrome();
		}
	}
}
?>
